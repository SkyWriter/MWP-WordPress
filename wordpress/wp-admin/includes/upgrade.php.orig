...
function wp_install_defaults($user_id) {
	...
	$default_links = array();
	$default_links[] = array(	'link_url' => 'http://mywordpress.ru/',
								'link_name' => 'MyWordPress.Ru',
								'link_rss' => 'http://mywordpress.ru/feed/',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://mywordpress.ru/support/',
								'link_name' => 'Форум поддержки',
								'link_rss' => '',
								'link_notes' => '');
