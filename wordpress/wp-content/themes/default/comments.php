...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Нет комментариев', 'Один комментарией', 'Комментариев: %' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3><?php comment_form_title( 'Оставить комментарий', 'Оставить комментарий на %s' ); ?></h3>
